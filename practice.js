...
const ENGLISH_PRACTICE_DRILLS = [
  ...
  },
  {
    ...
    sets: [
      ...
      {
        name: "Speed Booster 7 — Rediscovering the Grandeur of Ayodhya, Kashi and Mathura (Full Passage)",
        text: "In 2003, the Archaeological Survey of India , under the orders of the Lucknow Bench of Allahabad High Court, excavated the present temple site to ascertain if a temple ever existed. During the dig , they found clinching evidence in the form of the 12th-century Vishnu Hari inscription. It says: \"At the holy site of Ram's birth place in Saket ( Ayodhya ), a grand temple dedicated to Vishnu Hari is built . As part of religious duties , the temple administration has established an annsatra (community feeding centre). Visitors from far away, guests, saints and travellers are regularly provided free food.\" Let me mention here that many historians, including Irfan Habib, challenged the find. They alleged the inscription was taken from the Government Museum in Lucknow and planted at the site as evidence. The allegation couldn't be substantiated in the Supreme Court, and we all know the final result. Skanda Purana and the 7th-century Chinese traveller Huen Tsang 's accounts also support the claims of the inscription. These accounts not only establish the legitimacy of the Ram Temple's existence but point to the attributes that make Ayodhya an abode of virtue. Along with Ayodhya, Kashi and Mathura have their unique qualities too. Mathura is situated on the most important Uttarapath or the north path of India. It's part of the old Silk Route. Kushana- period inscriptions tell us that the treasury at the Krishna Janmasthan Temple acted as a bank. Local and foreign caravans would deposit their money here or seek loans for difficult trade journeys. Following in the footsteps of Krishna, the area had huge cowsheds. The grandeur of Kashi was absolutely unique . Kashi Khand ( chapter) of Skanda Purana declares it as India' s highest intellectual seat. The reason was that no new idea or principle would be universally accepted till it was debated and proved by the Kashi Vishwanath temple's \" intellectual committee\". Whether it was Shankaracharya or Ramanujacharya , every philosopher had to present, debate, and prove their hypothesis in this intellectual arena. The city of Vishwanath wasn't only limited to education but was also a great centre for astronomy , astrology , logic , and medicine. The Vishwanath Temple Council was also called Moksh Lakshmi Vilas. The granary of the Ma Annapoorna Temple situated close by ensured no one in Kashi would sleep hungry. Ayodhya was the symbol of the king's conduct and international cooperation and was considered a centre of good governance. Mathura was the centre of commercial banking , sculpting, agriculture and economics even before the advent of Christ. Kashi was the seat of education, learning, ayurveda and yoga. Temples like these have helped bring grace and sophistication to our civilisation and created a foundation to make it global. Temples in the south were making the same contribution towards our civilisation. We get away by offering lazy arguments that put the entire blame on foreign conquerors. Many historians believe that during periods of foreign rule, security concerns forced India's religious places into the hands of a chosen few. These people promoted very narrow visions on important issues. This was the beginning of the contraction of a great tradition."
      }
    ]
  }
];
